...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Galerians",
    .project_root_env = "GALERIANS_PROJECT_ROOT",
    .build_dir_env = "GALERIANS_BUILD_DIR",
    .force_setup_env = "GALERIANS_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLES_023.28_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Galerians",
    .prepare_note =
