...
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/galerians-recomp/total)](https://github.com/Alexbeav/galerians-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/galerians-recomp/latest/total)](https://github.com/Alexbeav/galerians-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/galerians-recomp)](https://github.com/Alexbeav/galerians-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **Galerians** built on
[psxrecomp](https://github.com/mstan/psxrecomp) and
[recomp-ui](https://github.com/RetroPortingToolKit/recomp-ui).

This is an owned-input setup kit. You supply your own SLES-02328, SLES-12328, SLES-22328 3 disc images
...
|---|---|
| Region | Europe |
| Disc serials | SLES-02328, SLES-12328, SLES-22328 |
| Discs | 3 |
...
2. Start `Galerians` (`.exe` on Windows).
3. In the setup wizard select your 3 disc images (the Redump CUE, or a CHD of the
...
and a C/C++ compiler first. Keep a CUE and every file it references together. Setup starts with Disc 1; later discs are selected when the game asks for them.
...
- Disc changes during play have not been qualified on the recompiled build; setup and start were verified with Disc 1.
...
named `diagnostic-mode.txt` next to `Galerians.exe` and start the game as
usual, or run `Galerians.exe --diagnostic`. Reproduce the problem, quit, then
run `Galerians.exe --collect-diagnostics`: it writes `diagnostics-<date>.zip`
